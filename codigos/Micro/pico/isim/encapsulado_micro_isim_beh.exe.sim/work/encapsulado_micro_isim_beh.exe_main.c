...
int main(int argc, char **argv)
{
    ...
    unisims_ver_m_00000000004165889721_2424106170_init();
    unisims_ver_m_00000000003104554403_1871821719_init();
    ...
    xsi_register_tops("work_m_00000000000672115035_3555082915");
